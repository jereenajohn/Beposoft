...
class UpdateBankTransferList extends StatefulWidget {
  final int id;
  const UpdateBankTransferList({super.key, required this.id});

  @override
  State<UpdateBankTransferList> createState() => _UpdateBankTransferListState();
}

class _UpdateBankTransferListState extends State<UpdateBankTransferList> {
  ...
  Future<void> updatebanktransfer() async {
    try {
      ...
      var response = await http.put(
        Uri.parse('$api/api/internal/transfers/${widget.id}/'),
        headers: {
