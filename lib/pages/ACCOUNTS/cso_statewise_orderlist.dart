...
class cso_StatewiseOrderList extends StatefulWidget {
  var state;
  cso_StatewiseOrderList({super.key, required this.state});

  @override
  State<cso_StatewiseOrderList> createState() => _cso_StatewiseOrderListState();
}

class _cso_StatewiseOrderListState extends State<cso_StatewiseOrderList> {
...
;
    ...
    if (response.statusCode == 200) {
      ...
      for (var orderData in ordersData) {
        ...
        // Exclude orders with family 'bepocart'
        if (widget.state == orderData['state'] &&
            (orderData['family'] == null || orderData['family'] != 'bepocart')) {
