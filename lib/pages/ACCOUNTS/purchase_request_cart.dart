...
import 'package:beposoft/pages/ACCOUNTS/purchase_request.dart';
...
class purchase_View_Cart extends StatefulWidget {
  const purchase_View_Cart({super.key});

  @override
  State<purchase_View_Cart> createState() => _purchase_View_CartState();
}

class _purchase_View_CartState extends State<purchase_View_Cart> {
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>purchase_request()));
                    },
