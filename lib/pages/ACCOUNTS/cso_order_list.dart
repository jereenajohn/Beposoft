...
class CsoOrderList extends StatefulWidget {
  var status;
  CsoOrderList({super.key, required this.status});

  @override
  State<CsoOrderList> createState() => _CsoOrderListState();
}

class _CsoOrderListState extends State<CsoOrderList> {
