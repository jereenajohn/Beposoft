...
class add_pro_categories extends StatefulWidget {
  const add_pro_categories({super.key});

  @override
  State<add_pro_categories> createState() => _add_pro_categoriesState();
}

class _add_pro_categoriesState extends State<add_pro_categories> {
  @override
  void initState() {
    super.initState();
    getproductcategory();
  ...
  void addproductcategory(BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => add_pro_categories()));
