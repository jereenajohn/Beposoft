...
class csoOrderList2 extends StatefulWidget {
  var status;
  csoOrderList2({super.key, required this.status});

  @override
  State<csoOrderList2> createState() => _csoOrderList2State();
}

class _csoOrderList2State extends State<csoOrderList2> {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      for (var orderData in ordersData) {
        final String family = (orderData['family'] ??
        ...
        // Do not show bepocart family orders
        if (family == 'bepocart') {
          continue;
        }
