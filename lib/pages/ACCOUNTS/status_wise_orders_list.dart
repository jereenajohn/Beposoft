...
class OrderList2 extends StatefulWidget {
  var status;
  OrderList2({super.key, required this.status});

  @override
  State<OrderList2> createState() => _OrderList2State();
}

class _OrderList2State extends State<OrderList2> {
