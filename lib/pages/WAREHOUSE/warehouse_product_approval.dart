...
// }
  ...
  Future<void> addtocart2(
      BuildContext scaffoldContext, mainid, quantity) async {
    final token = await getTokenFromPrefs();
    try {
      final response = await http.post(Uri.parse('$api/api/cart/product/'),
          headers: {
          ...
          body: jsonEncode({'product': mainid, 'quantity': quantity}));
...
//
  ...
  void showSizeDialog2(BuildContext context, var products) {
    List variants = products['variantIDs']
        .where((variant) => variant['approval_status'] == "Disapproved")
        .toList();
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  "Purchase Rate: \$${products['purchase_rate']}"),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: products['approval_status'] == "Approved"
                          ? null
                          : () {
                      ...
                      child: Text("Approve Main Product",
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text("Approve Selected Variant",
                          style: TextStyle(color: Colors.white)),
                      style: ElevatedButton.styleFrom(
                                ...
                                onPressed: () {
                                  if (product['is_vaiant'] == true) {
                                    ...
                                    List<String> colors = extractStringList(
                                        product['colors'] ?? [], 'color_name');
                                    List<Map<String, dynamic>> sizes =
                                        extractSizeList(product['sizes'] ?? []);
                                    ...
                                    showSizeDialog2(context, product);
                                    ...
                                    child: Row(
                                      children: [
                                        if (variantProduct['image'] != null &&
                                            variantProduct['image'].isNotEmpty)
                                          Image.network(
