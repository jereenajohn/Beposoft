  ...
  void addsupervisor(String name, BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => add_supervisor()));
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: dep
                                      .map<DropdownMenuItem<int>>((department) {
                              ...
                              TableRow(
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                        "${manager[i]['name']}(${manager[i]['department_name']})"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
