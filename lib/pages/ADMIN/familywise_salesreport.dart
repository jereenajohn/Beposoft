...
class FamilywiseSalesreport extends StatefulWidget {
  var family;
  var date;
  ...
  @override
  State<FamilywiseSalesreport> createState() => _FamilywiseSalesreportState();
}

class _FamilywiseSalesreportState extends State<FamilywiseSalesreport> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var orderData in ordersData) {
          ...
          // Filter by family and widget.date
          if (orderData['family'] == widget.family &&
              formattedOrderDate == widget.date) {
